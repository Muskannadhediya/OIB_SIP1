...
// Represents the bank account information database
    ...
    public class BankDatabase
    {
        ...
        public static void Adduser(){
            ...
            int accountnumber = Integer.parseInt( Inputfield2.getText() );
            int pin = Integer.parseInt( Inputfield4.getText() );
            int balance = Integer.parseInt( Inputfield3.getText() );
        ...
        private static class Inputfield4 {
            public static String getText() {
                return null;
            }
        }

        private static class Inputfield3 {
            public static String getText() {
                return null;
            }
        }
